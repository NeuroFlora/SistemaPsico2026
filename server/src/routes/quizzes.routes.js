...
function mapSeveridad(codigo, score) {
    ...
    switch (cod) {
        ...
        case "BDI-II":
        case "BDI2": // Por si acaso llega sin el guion
        ...
        case "DAST10":
            ...
            if (score <= 8) return "MODERADA";
            return "SEVERA";

        default:
            return "TEST NO RECONOCIDO"; // Siempre es bueno tener un caso por defecto
    }
}
