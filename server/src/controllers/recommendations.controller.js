...
const getPersonalizedRecommendations = async (req, res) => {
  try {
    ...
    const personalizedRecommendations = [
      ...
      {
        id: 3,
        title: 'Terapia Psicológica Especializada.',
        description: 'La Terapia Cognitivo-Conductual (TCC): Ayuda al individuo a identificar los desencadenantes del consumo, desarrollar habilidades de afrontamiento ante el estrés y modificar los patrones de pensamiento que sostienen la adicción.',
        category: 'Mindfulness',
        priority: 'high',
        type: 'presencial',
        duration: '20 min',
        ...
        rating: 4.9,
        isViewed: false,
        tags: ['Meditación', 'Apoyo', 'Dependencia'],
        personalizedReason: 'Recomendado para tu nivel de dependencia al alcohol y nicotina.'
      },
      {
        id: 4,
        title: 'Intervenciones Breves.',
        description: 'Establecer redes de colaboración directa con centros especializados en adicciones y profesionales de la salud mental.',
        category: 'Mindfulness',
        priority: 'high',
        type: 'presencial',
        duration: '20 min',
        ...
        isViewed: false,
        tags: ['Meditación', 'Apoyo', 'Dependencia'],
        personalizedReason: 'Recomendado para tu nivel de dependencia a drogas.'
      }
    ];
    ...
    const mockResources = [
      {
        id: 5,
        title: 'LINEA DE VIDA',
        description: 'Recurso integral del centro comunitario de salud mental y adicciones en el ámbito académico.',
        type: 'nota',
...
const getRecommendedExercises = async (req, res) => {
  try {
    ...
    const mockExercises = [
      ...
      {
        id: 12,
        title: 'Espacios Libres de Humo y Emisiones',
        description: 'Frecuentar e incentivar áreas donde el consumo esté restringido ayuda a disminuir la exposición a estímulos visuales y sociales que inviten a consumir.',
        category: 'Practico',
        difficulty: 'Intermedio',
        duration: '20 min',
        completions: 950,
        benefits: ['Reduce consumo', 'Mejora confianza', 'Prepara mentalmente'],
        steps: 7
      }
    ];
...
const getCategories = async (req, res) => {
  try {
    const mockCategories = [
      ...
      { id: 8, name: 'Dependencia', count: 28}
    ];
